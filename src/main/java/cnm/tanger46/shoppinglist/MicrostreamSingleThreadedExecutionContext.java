...
public class MicrostreamSingleThreadedExecutionContext {
    ...
    public Single<EmbeddedStorageManager> start() {
        var completableFuture = CompletableFuture.supplyAsync(storage::start, executor);
    ...
    public <T> Single<T> root() {
        var completableFuture = CompletableFuture.supplyAsync(() -> (T) storage.root(), executor);
        return Single.create(completableFuture);
    }
    ...
    public Single<Object> setRoot(Object object) {
        var completableFuture = CompletableFuture.supplyAsync(() -> storage.setRoot(object), executor);
        return Single.create(completableFuture);
    }
    ...
    public Single<Long> store(Object object) {
        var completableFuture = CompletableFuture.supplyAsync(() -> storage.store(object), executor);
        return Single.create(completableFuture);
    }
